...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement("ALTER TABLE project_updates ADD CONSTRAINT project_updates_status_check CHECK (status IN ('pending_review', 'approved', 'needs_revision', 'pending_approval', 'superseded'))");
    }
