    ...
    <div class="client-header-right">
        ...
        <div class="notification-dropdown" id="notificationDropdown">
            ...
            <div class="notification-dropdown-menu" id="notificationDropdownMenu">
                ...
                <a href="{{ route('client.notifications') }}" class="view-all-notifications" id="viewAllLink" style="display:none;">
        ...
        <div class="client-dropdown">
            <button class="client-profile-btn" id="clientDropdownBtn">
                <div class="client-avatar">
                    ...
                    @else
                        <span style="font-size:16px;font-weight:900;color:var(--dark);">
                            {{ strtoupper(substr(session('name', 'C'), 0, 1)) }}
                        </span>
                    @endif
                </div>
...
(function () {
    ...
    const clientBtn            = document.getElementById('clientDropdownBtn');
    const notificationDropdown = document.querySelector('.notification-dropdown');
    const notificationBtn      = document.getElementById('notificationDropdownBtn');

    if (clientBtn && clientDropdown) {
...
(function () {
    const UNREAD_MESSAGES_URL = '{{ route("client.messages.unread_count") }}';
