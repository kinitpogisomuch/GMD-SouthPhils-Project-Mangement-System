...
<head>
    ...
    <title>{{ $client }} | Project Quotation | GMD South Phils</title>
                    ...
                    <table class="data-table" id="materialsTable">
                        ...
                        <tbody>
                            ...
                            <tr data-status="{{ $project->status }}">
                                ...
                                @php $empCount = $project->assignedEmployees->count(); @endphp
                                <td style="text-align:center;">
                                    <span style="font-weight:700;">{{ $empCount }}</span>
                                    <span style="color:var(--muted);font-size:13px;"> employee{{ $empCount !== 1 ? 's' : '' }}</span>
                                </td>
                            ...
                            <tr id="filterEmptyRow" style="display:none;">
                                <td colspan="7" style="text-align:center;padding:60px 20px;color:var(--muted);">
                                    ...
                                    <div style="font-size:13px;margin-top:4px;color:var(--muted);">Try switching to a different tab.</div>
                                </td>
                            </tr>
                        </tbody>
                    </table>
